...
<header class=" bg-secondary">
	<div class="navbar max-w-screen-2xl mx-auto flex justify-between">
		<div class="">
			<a href="/" class="text-xl text-">SoSaa</a>
		</div>
		...
		<nav class="flex justify-center">
			...
			<div class="dropdown dropdown-end">
				...
				<ul
					class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 bg-secondary"
				>
					<li class="p-3">Jonmar Montaniel</li>
					<li>
